            ...
            <div class="container">
                ...
                <div class="features-grid">
                    <article class="feature-card">
                        ...
                        <p>Что делать при удушье, ожоге, падении, потере сознания или высокой температуре до приезда врачей.</p>
                    </article>
                    <article class="feature-card">
                    ...
                    <article class="feature-card">
                        ...
                        <p>Без сложной теории и медицинских терминов: демонстрация, тренировка и обратная связь инструктора.</p>
                    </article>
                </div>
            </div>
        </section>
