    ...
    <header class="hero">
        <div class="container hero-content">
            ...
            <div class="hero-offer" aria-label="Стоимость и условия участия">
                ...
                <span>8 часов · группа до 14 человек · бесплатный повтор, если нужно больше практики</span>
            </div>
            ...
            <div class="hero-note">
                <strong>Гарантия навыка:</strong> если после занятия вы не чувствуете уверенности
                в базовых алгоритмах, бесплатно приходите на практику со следующей группой.
            </div>
        </div>
    </header>
                ...
                <div class="pricing-grid">
                    <article class="pricing-card">
                        ...
                        <ul class="pricing-list">
                            ...
                            <li>Бесплатный повтор практики при необходимости</li>
                            <li>Кофе-брейки</li>
                        </ul>
                        <button
                            type="button"
            ...
            <div class="container">
                <div class="registration-panel">
                    ...
                    <ul class="commitment-points" aria-label="Условия заявки">
                        ...
                        <li><strong>Гарантия навыка</strong><span>Повтор практики бесплатно, если он понадобится</span></li>
                    </ul>
